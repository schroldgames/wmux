...
export default function BrowserPane({ initialUrl = 'https://github.com/amirlehmam/wmux', surfaceId, onUrlChange }: BrowserPaneProps) {
  ...
  // Listen for programmatic navigation scoped to this surface.
  // Events with no surfaceId are broadcasts (backwards-compat); events with a
  // surfaceId only fire on the matching pane.
  useEffect(() => {
